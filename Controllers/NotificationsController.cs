...
namespace BugTracksV3.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Title,Message,DateCreated,RecipientId,SenderId,IsRead")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Title,Message,DateCreated,RecipientId,SenderId,IsRead")] Notification notification)
        {
